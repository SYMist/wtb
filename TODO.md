...
- [x] **GSC 색인 재요청 완료** (SSR 복구 후 주요 페이지 재크롤 요청, 2026-05-30)

> **Phase 0 = 관찰 대기 구간 진입.** 능동 작업 끝. 남은 것: (1) 양도세 블로그 글 실제 발행(권위 링크), (2) **1~2주 후 GSC 재색인 여부 + GA 유입 신호 확인** → 색인되면 Phase 1 본격화, 안 뜨면 부업 매체 재고. 그 사이는 데이터 포털(해자)·Phase 2 제휴 조사 등 비-검증 작업 진행 가능.
...
- [ ] **다음 블로그 글 = S1 양도세(1세대1주택 12억 초과)** — 보강된 양도세 페이지로 권위 링크 주입 (개선된 플레이북 기준). 주담대 원리금균등 vs 원금균등은 후순위
