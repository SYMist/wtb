/**
 * 국고채 10년 수익률 월평균 / ECOS 817Y002 item 010210000
 *
 * 실행: npx tsx --env-file=.env.local scripts/fetch-treasury10y-rate-series.ts
...
const OUTPUT_PATH = join(
  process.cwd(),
  "lib/data/treasury10y-rate-series.json",
);
