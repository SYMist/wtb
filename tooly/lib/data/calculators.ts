...
export const calculators: Calculator[] = [
  ...
  },
  {
    ...
    keywords: ["퇴직금", "퇴직소득세", "퇴직금 실수령액", "근속", "평균임금", "퇴직금계산기", "퇴직금얼마", "퇴직소득세 계산"],
    relatedIds: ["capital-gains-tax", "salary-calculator", "compound-interest"],
    seo: {
      title: "퇴직금 계산기 - 퇴직소득세·세후 실수령액까지 | Tooly",
      description: "입사일·퇴사일·월급으로 예상 퇴직금과 퇴직소득세(근속연수공제·환산급여·연분연승)를 계산해 세후 실수령액을 보여줍니다. 근속연수별 세금 차이 확인.",
      h1: "퇴직금 계산기",
      faq: [
        { question: "퇴직금 계산법은?", answer: "퇴직금 = 1일 평균임금 × 30일 × (계속 근로기간 ÷ 365)로 계산됩니다. 1일 평균임금은 퇴직 직전 3개월 임금 총액을 그 기간 일수(약 91일)로 나눈 값으로, 정기 상여금·연차수당도 포함됩니다." },
        { question: "퇴직금 수령 조건은?", answer: "계속 근로기간 1년 이상이고 주 소정 근로시간이 15시간 이상인 근로자가 퇴직 시 수령할 수 있습니다. 1년 미만 근무하면 퇴직금이 발생하지 않습니다." },
        { question: "퇴직금과 퇴직소득세는 어떻게 다른가요?", answer: "퇴직금은 받는 금액이고, 퇴직소득세는 그 퇴직금에 부과되는 세금입니다. 퇴직소득세는 근속연수공제 → 환산급여(× 12 ÷ 근속연수) → 환산급여공제 → 세율 → 산출세액(× 근속연수 ÷ 12)의 '연분연승' 구조라, 근로소득세와 계산 방식이 완전히 다릅니다." },
        { question: "근속연수가 길면 세금이 줄어드나요?", answer: "네. 연분연승 구조와 근속연수공제 덕분에 같은 퇴직금이라도 근속이 길수록 세금이 급감합니다. 예를 들어 퇴직금 3,000만원이 근속 3년이면 약 137만원, 12년이면 약 5만원의 세금이 부과됩니다." },
        { question: "근속연수는 어떻게 산정하나요?", answer: "입사일부터 퇴사일까지의 계속 근로기간으로 산정하며, 1년 미만 기간은 1년으로 올림하여 근속연수공제에 적용합니다. 중간정산을 받았다면 정산 시점 이후 기간만 다시 계산됩니다." },
        { question: "퇴직금 중간정산을 받으면 세금이 어떻게 되나요?", answer: "법정 사유(무주택자 주택 구입, 전세보증금, 6개월 이상 요양 등)로 중간정산을 받으면 그 시점에 근속연수가 리셋됩니다. 이후 퇴직 시 근속연수가 짧아져 같은 금액이라도 세 부담이 커질 수 있습니다." },
        { question: "DB형과 DC형 퇴직연금의 차이는?", answer: "DB형(확정급여)은 퇴직 직전 평균임금 × 근속연수로 법정 퇴직금과 사실상 같습니다. DC형(확정기여)은 회사가 매년 연봉의 1/12을 적립하고 운용 수익이 더해져, 성과에 따라 법정 퇴직금보다 많거나 적을 수 있습니다. 본 계산기는 법정 퇴직금·DB형 기준입니다." },
      ],
    },
  },
  {
